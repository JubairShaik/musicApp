    ...
    <>
      ...
      >
        {({
          ...
          <div className="bg-primary bg-gradient-to-tl  from-cyan-500  to-blue-500 text-white font-poppins flex justify-center items-center h-screen ">
            <div className="bg-blue-500  shadow-lg shadow-emerald-500 rounded-lg  px-3 py-10 w-[85%] sm:w-[30%] ">
              ...
              <div className=" flex mx-2 mt-5 gap-3 items-center justify-center ">
                <h2 className="text-black text-l  sm:text-lg">Dont Have An Account ? </h2> 
                    <Link to="/signup" >
